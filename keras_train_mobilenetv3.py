...
#base_model = MobileNetV3(input_tensor=vww_input, alpha=0.25, model_type='small', classes=2, weights=None, include_top=True)
base_model = MobileNetV3(input_tensor=vww_input, alpha=0.25, classes=2, weights=None, include_top=True)
...
model_ckpt = tf.keras.callbacks.ModelCheckpoint(
        os.path.join("keras_birds", "mobilenetv3-kmod") + '-ckpt-{epoch:03d}.h5',
        monitor='val_loss',
        save_best_only=True)
...
save_name = "keras_birds_mobilenet_v3"
